-- Enter a customer's delivery order into our database,and provide the total cost of the items ordered.
...
FROM Customers
WHERE FirstName='Loretta' AND LastName='Hundey';--CustomerID is 70--
